...
class InventoryDatabase:
    """
    Thread-safe SQLite wrapper с WAL оптимизация за Raspberry Pi SD карти.
    
    Всички публични методи са защитени с threading.Lock(), което позволява
    безопасно използване от AsyncScanner (ThreadPoolExecutor) и главния цикъл
    едновременно, без риск от "database is locked" грешки.
    """
